...
public abstract class NGRoomManager {
	...
	// Devuelve un booleano indicando si la sala puede admitir a mas jugadores
	public abstract boolean available();
	// Devuelve un booleano indicando si un jugador se encuentra en una sala
	public abstract boolean contains(NGPlayerInfo player);
	// Comprobar si una sala debe ser eliminada
	public abstract boolean checkEliminar();
